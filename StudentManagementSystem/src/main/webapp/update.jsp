...
<div class="container">
<div class=card>
<div class="card-title"> <h3>Updating Student Information</h3></div>
<div class="card-content">
<form action="update">

<label for ="updateStudent">Enter the StudentId</label>
<br>
<input type="number" name="studentId" >
<br>

Enter the updated phone number : - <input type="number" name="upn">
<br>
