...
<div class="card">
<div class="card-title"><marquee><h4>Deleting Student</h4></marquee></div>
...
<label for="stdDelete">Enter the Student Id</label>
<input type="number" name ="studentNumber" id="stdDelete">
<br>
